...
public class BinaryTreeTests {
	...
	public void Attach_normalBehavior_nodesAttached()
		...
		assertEquals("El método attach no vincula correctamente el subárbol izquierdo.", rootT1, binaryTree.left(root));
		assertEquals("El método attach no vincula correctamente el subárbol izquierdo.", rootT2,
