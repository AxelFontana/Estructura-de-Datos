...
public class CaminoCorto2 {
		public static void main(String[] args) {
			...
			PositionList<Vertex<Character>> resultado = caminoEconomico(A, B, G);
		...
		private static void caminoEco2 (Vertex<Character> origen, Vertex<Character> destino, GraphD<Character,Integer> G, Map<Vertex<Character>, Boolean> visitados, Par caminoCorto, PositionList<Vertex<Character>> caminoAux, Integer pesoAux){
