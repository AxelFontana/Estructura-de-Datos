...
public class TreeTest {
    ...
    public void addBefore() {
        ...
        try {
            ...
            hijosH1 = new ListaDobleEnlaze<Integer>();
            hijosH1.addFirst(4);
            hijosH1.addFirst(5);
            hjsH1 = new ListaDobleEnlaze<Integer>();
    ...
    public void addAfter() {
        ...
        try {
            ...
            chequearPadre(T.root());
            // caso de prueba para los hijos de root
            PositionList<Integer> hijosRoot = new ListaDobleEnlaze<Integer>();
            hijosRoot.addFirst(2);
            hijosRoot.addFirst(7);
            hijosRoot.addFirst(3);
            hijosRoot.addFirst(6);
            hijosRoot.addFirst(9);
            PositionList<Integer> hijos = new ListaDobleEnlaze<Integer>();
            for (Position<Integer> n : T.children(T.root())) {
    ...
    public void removeInternal() {
        ...
        lista = new ListaDobleEnlaze<Integer>();
        for (i = 1; i <= 12; i++)
            lista.addLast(i);
    ...
    public void remove() {
        ...
        T = getTree();
        cargarArbol2(T);
        lista = new ListaDobleEnlaze<Position<Integer>>();
        try {
